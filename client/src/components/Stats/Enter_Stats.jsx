  ...
  return (
    <div>
      ...
      <Modal
        ...
        appElement={document.getElementById("root")} // Replace 'root' with your root element ID
      >
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            <label htmlFor="vehicle_type" className="block mb-1">
              vehicle type
            </label>
            <input
              type="text"
